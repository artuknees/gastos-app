            ...
            { !isLoading && categories.length > 0 ? 
                <form className="w-full h-full flex flex-col pt-4" onSubmit={() => handleSubmit()}>
                    ...
                    <label className="font-semibold text-lg">Monto</label>
                        ...
                        type='number'
                        onChange={(e) => setDataPack({...dataPack, valor:parseInt(e.target.value)})}
                        className={`bg-transparent border h-[45px] rounded-full px-4 mt-2 shadow-lg ${dataPack.valor === 0 ? 'border-black-main' : 'border-red-main'}`}
                        />
                    </div>
                    <div className="w-full flex flex-col mb-5">
                    <label className="font-semibold text-lg">Comentario</label>
                        ...
                        type='text'
                        className={`bg-transparent border h-[45px] rounded-full px-4 mt-2 shadow-lg ${dataPack.comentario === '' ? 'border-black-main' : 'border-red-main'}`}
                    ...
                    <label className="font-semibold text-lg">Categoria</label>
                        ...
                        className={`bg-transparent appearance-none border h-[45px] rounded-full px-4 mt-2 shadow-lg ${dataPack.categoria === '' ? 'border-black-main' : 'border-red-main'}`}
                        >
